...
function CalendarEvent() {
  const [arrEvt, setArrEvt] = useState(
    () => JSON.parse(localStorage.getItem("eventDay"))
  )
    ...
    <>
      <div className="grid grid-cols-10">
        ...
        <div className="col-span-8">
          <NavBars />
          <div className="m-5">
            <h1 className="font-bold text-[35px] uppercase">LỊCH BIỂU</h1>
            <CreateEvent
        ...
        >
          <DialogHeader>
            <div className="flex justify-between w-full">
              ...
              <button onClick={() => setSize(null)} className="text-[17px]">
                X
              </button>
            </div>
          </DialogHeader>
